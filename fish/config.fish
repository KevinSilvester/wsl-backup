...
if status is-interactive
  ...
  alias wezterm-config='lvim $WEZTERM_CONFIG/wezterm.lua'
  alias bird-eggs='lvim $ROOT/bird-eggs.json'
  alias bird-nest='lvim $ROOT/bird-nest.json'
